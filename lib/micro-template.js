...
const template = function (id, data) {
	...
	if (!me.cache.has(key)) me.cache.set(key, (function () {
		...
		const body = (
			...
			`//# sourceMappingURL=data:application/json,${encodeURIComponent(JSON.stringify({version: 3, file: 'template.js', sources: ['template.ejs'], sourcesContent: [string], mappings: ";;AAAA;" + Array(line).fill('AACA').join(';')}))}`
		);
